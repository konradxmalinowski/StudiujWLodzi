...
const SECTIONS = [
    {
      ...
      image: require('@/assets/images/lodz1.png'),
      imageName: 'lodz1.png',
    ...
    },
    {
      ...
      image: require('@/assets/images/lodz2.png'),
      imageName: 'lodz2.png',
    ...
    },
    {
      ...
      image: require('@/assets/images/lodz3.png'),
      imageName: 'lodz3.png',
    ...
    },
    {
      ...
      image: require('@/assets/images/lodz1.jpg'),
      imageName: 'lodz1.jpg',
      ...
      <ScrollView contentContainerStyle={styles.container}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={styles.gallery}>
          <Pressable onPress={() => router.push({ pathname: '/modal', params: { image: 'lodz1.jpg' } })}>
            <AnimatedImage source={require('@/assets/images/lodz1.jpg')} style={[styles.image, { opacity: imageOpacity }]} />
          </Pressable>
          <Pressable onPress={() => router.push({ pathname: '/modal', params: { image: 'lodz2.jpg' } })}>
            <AnimatedImage source={require('@/assets/images/lodz2.jpg')} style={[styles.image, { opacity: imageOpacity }]} />
          </Pressable>
          <Pressable onPress={() => router.push({ pathname: '/modal', params: { image: 'lodz3.png' } })}>
            <AnimatedImage source={require('@/assets/images/lodz3.png')} style={[styles.image, { opacity: imageOpacity }]} />
          </Pressable>
          <Pressable onPress={() => router.push({ pathname: '/modal', params: { image: 'lodz4.png' } })}>
            <AnimatedImage source={require('@/assets/images/lodz4.png')} style={[styles.image, { opacity: imageOpacity }]} />
          </Pressable>
